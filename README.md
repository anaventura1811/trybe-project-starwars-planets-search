...
Projeto desenvolvido como requisito parcial para conclusão do módulo Front-end do curso de Desenvolvimento Web da Trybe. Neste projeto, foi desenvolvido uma lista com filtros de planetas do universo de Star Wars usando **Context API e Hooks** para controlar os estados globais, a partir dos requisitos técnicos abaixo descritos.
